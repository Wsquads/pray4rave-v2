...
<form  method="post" action="{{ route('manageReleases.saveRelease') }}" enctype="multipart/form-data"  class="py-32">
    @csrf
      ...
      <div class="flex h-screen bg-gray-200 items-center justify-center  mt-32 mb-32">
        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
            ...
            <div class="grid grid-cols-1 mt-5 mx-7">
              ...
              <input  name="tittle" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" placeholder="nick" />
              <!-- Error -->

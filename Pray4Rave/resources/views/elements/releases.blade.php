...
<div class="blogs__wraper py-20 px-20">
    ...
    <div class="max-w-screen-lg mx-auto">
        ...
        <div class="border-1">
          ...
          <div class="pb-8  mb-4
           pt-4  text-center">
            <h1 class="pb-4 font-semibold text-7xl mb-4 text-center">RELEASES</h1>
  
            <div class="box mb-8">
              <div class="box-wrapper">
                <form action="{{route('releases.search')}}">
                  @csrf
                  <div class=" bg-white rounded flex items-center w-full p-3 ">
                    ...
                    <div class="select">
                      <select name="r_type" id="" class="font-sans rounded text-sm outline-none focus:outline-none bg-transparent">
                        <option value="all" selected>All</option>
                        <option value="albums">Albums</option>
                        <option class="releases" value="technology">Releases</option>
                      </select>
                    </div>

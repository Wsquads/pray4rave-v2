@extends('welcome')
@section('content')
<form  method="post" action="{{ route('manageArtists.editAndSave', ['id'=>$id_a]) }}" enctype="multipart/form-data"  class="py-32">
  @csrf
      ...
      <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
          ...
          <div class="flex justify-center">
            ...
            <div class="flex">
              ...
              <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Update an Artist</h1>

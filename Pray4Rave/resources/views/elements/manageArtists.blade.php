                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    <div class="m-1 pt-2  transform hover:text-purple-500 hover:scale-110">
                                        <a class="shadow bg-purple-400 rounded  text-gray-100 p-2" href="{{route('manageArtists.editar', ['id'=> $item->id])}}">Editar</a>
                                    </div>
                                    <div class=" m-1 shadow transform hover:text-purple-500 hover:scale-110">
                                        <form action="{{route('manageArtists.delete', ['id'=> $item->id])}}" method="POST">
                                            @csrf

@extends('welcome')
@section('content')
<form  method="post" action="{{ route('posts.editAndSave',['id'=>$id_p]) }}" enctype="multipart/form-data"  class="mb-44 mt-16">
    @csrf
        ...
        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
            ...
            <div class="flex justify-center">
              ...
              <div class="flex">
                ...
                <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Update a Post</h1>
